...
class class_K400 extends class_top {
    var $m_3pl = "";
    var $m_connect = "";
    ...
    function query()
    {
	global $template,$status,$txt_name, $start_date, $end_date;
...
*/
	...
	// $this->opener_redirect ( "template.htm?template=K400" );
        exit;
    }
	...
	foreach( $_data as $product_id=>$qty )
	{
        ...
        echo "<script>document.location.href = 'template.htm?template=K402&sheet=$sheet';</script>";
        exit;
    ...
    function save_stock_wait()
    {
        ...
        echo "<script>document.location.href = 'template.htm?template=K400';</script>";
        exit;
    }
	...
	*/
        ...
        echo "<script>opener.location.reload();</script>";
	$this->redirect("?template=K400&action=win_close");
	exit;
    }
...
echo $sql;
    ...
    //////////////////////////////////////
    function get_name_sheet_sts2($status)
    {
        switch ($status)
        {
            case 1:
    ...
    function get_goods_cnt2($sheet)
    {
	$sql = "select count(*) cnt from 3pl_stock_in
		 where sheet = '$sheet'";
