...
////////////////////////////////
// class name: class_H300
//

class class_H300 extends class_top {
	...
	echo "<script>document.location.href = '?template=H300';</script>";
	exit;
    }
	...
	mysql_query($sql, $connect) or die(mysql_error());
	echo "<script>document.location.href = '?template=H301&no=$no&subno=$subno';</script>";
    }
}
